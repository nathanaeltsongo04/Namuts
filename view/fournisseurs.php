...
Swal.fire({
    ...
    //location.replace('Fournisseurs.php');
});
      </script>
      <?php } ?>
      <!-- Left side columns -->
                          ...
                          <table class="table table-borderless datatable">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><?= $val['EMAIL'] ?></td>
                                      <td><?= $val['ADDRESSE'] ?></td>
                                      <td><span data-id='<?= $val['CODEFOURNISSEUR'] ?>'
                                              class="badge bg-success elementinfo "><i
                                                  class="bi bi-pencil-fill "></i></span>
                                          <span data-id='<?= $val['CODEFOURNISSEUR'] ?>'
                  ...
                  <form class="row g-3" method="POST" action="./controller/Fournisseurs.php">
                      <div class="modal-body">
                          <div class="row justify-content-center">
                              ...
                              <div class=" col-md-10 mb-2 mt-1 ">
                                  <div class="input-group has-validation">
                                      <input type="tel" pattern="[0-9]{10}" name="telephone" class="form-control"
