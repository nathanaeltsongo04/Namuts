                                     ...
                                     <?php
                                        ...
                                        ?>
                                         <tr>
                                             ...
                                             <td><?= $val['SIGLE'] ?></td>
                                             <td><?= $val['AUTEUR'] ?></td>
                                             <td><span data-id='<?= $val['CODEUNITE'] ?>' class="badge bg-success elementinfo "><i class="bi bi-pencil-fill "></i></span>
                                                 <span data-id='<?= $val['CODEUNITE'] ?>' class="badge bg-danger elementinfo "><i class="bi bi-trash-fill "></i></span>
