<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-heading mt-4">Menu</li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="Approvisionnements.php">
            ...
            <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="charts-chartjs.html">
                        <i class="bi bi-circle"></i><span>Entrées</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="charts-echarts.html">
                        <i class="bi bi-circle"></i><span>Mouvements Stock</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Stock Nav -->
