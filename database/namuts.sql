...
DELIMITER //
CREATE PROCEDURE GESTION_PRODUIT
(
	IN P_OPERTATION TEXT,
	IN P_CODEPRODUIT VACHAR(14),
	IN P_DESIGNATION TEXT,
	IN P_UNITE INT,
	IN P_SEUIL INT,
	IN P_CATEGORIE INT ,
	IN P_AUTEUR TEXT
...
BEGIN
    ...
    -- Générer la clé primaire finale
		...
		CODE, P_DESIGNATION, P_UNITE,P_SEUIL,P_CATEGORIE,P_AUTEUR);
