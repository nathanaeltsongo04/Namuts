...
(
	IN UT_OPERATION TEXT,
	IN UT_MATRICULE VARCHAR(15),
	IN UT_NOM TEXT,
	IN UT_POSTNOM TEXT,
	IN UT_PRENOM TEXT,
	IN UT_CONTACT VARCHAR(14),
	IN UT_EMAIL TEXT,
	IN ADDRESSE TEXT,
	IN PHOTO TEXT
)
...
/*========================LES PROCEDURE STOCKEES GESTION_COMPTE===========================*/
DROP PROCEDURE IF EXISTS GESTION_COMPTE;
DELIMITER //
CREATE PROCEDURE GESTION_COMPTE
(
	IN CODECOMPTE
)